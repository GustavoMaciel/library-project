...
public class TranslatorUtil {
    ...
    public static final String ITEM_UPDATE_INCONSISTENT = "item.update.inconsistent";
     ...
     * @see Logger
     */
    private static final Logger LOGGER = Logger.getLogger(br.edu.ufcg.virtus.library.util.TranslatorUtil.class.getName());
